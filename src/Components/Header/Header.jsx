    ...
    return (
        <header className='w-full'>
            <div className='relative'>
                ...
                <div className='absolute top-0 left-0 right-0 bottom-0 flex flex-col justify-center items-center bg-slate-900 bg-opacity-50'>
                    ...
                    <motion.div initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ duration: 2, type: 'spring', bounce: .5, damping: 5, delay: 1, }} className='flex justify-center items-center flex-wrap md:gap-10 gap-y-10 md:gap-y-0 mt-5 text-white text-nowrap'>
                        <div className='order-4 flex flex-col gap-y-10 justify-between items-center md:w-20 w-1/2 group/changeColor'>
                        ...
                        <div className='order-3 flex flex-col gap-y-10 justify-between items-center md:w-20 w-1/2 group/changeColor'>
                        ...
                        <div className='order-2 flex flex-col gap-y-10 justify-between items-center md:w-20 w-1/2 group/changeColor'>
                        ...
                        <div className='order-1 flex flex-col gap-y-10 justify-between items-center md:w-20 w-1/2 group/changeColor'>
            ...
            <div className='w-full p-3 bg-[#e64c43] flex justify-center items-center gap-5 text-white'>
                ...
                <motion.button initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 1 }} className='bg-white p-3 rounded-md text-[#e64c43] text-xl font-bold'>احجز الأن</motion.button>
            </div>
        </header>
    )
}
